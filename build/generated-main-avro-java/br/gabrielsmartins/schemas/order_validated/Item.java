...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9198296346242067160L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"br.gabrielsmartins.schemas.order_validated\",\"fields\":[{\"name\":\"product_id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"},{\"name\":\"amount\",\"type\":{\"type\":\"bytes\",\"logicalType\":\"decimal\",\"precision\":9,\"scale\":2}}]}");
...
static {
   ...
   */
  public static br.gabrielsmartins.schemas.order_validated.Item.Builder newBuilder() {
    return new br.gabrielsmartins.schemas.order_validated.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static br.gabrielsmartins.schemas.order_validated.Item.Builder newBuilder(br.gabrielsmartins.schemas.order_validated.Item.Builder other) {
    if (other == null) {
      return new br.gabrielsmartins.schemas.order_validated.Item.Builder();
    } else {
      return new br.gabrielsmartins.schemas.order_validated.Item.Builder(other);
    }
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static br.gabrielsmartins.schemas.order_validated.Item.Builder newBuilder(br.gabrielsmartins.schemas.order_validated.Item other) {
    if (other == null) {
      return new br.gabrielsmartins.schemas.order_validated.Item.Builder();
    } else {
      return new br.gabrielsmartins.schemas.order_validated.Item.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.gabrielsmartins.schemas.order_validated.Item.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.gabrielsmartins.schemas.order_validated.Item other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.product_id)) {
        this.product_id = data().deepCopy(fields()[0].schema(), other.product_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder setProductId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder clearProductId() {
      product_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder clearQuantity() {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder setAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_validated.Item.Builder clearAmount() {
      amount = null;
