...
static {
  ...
  @Deprecated public br.gabrielsmartins.schemas.order_requested.PaymentType payment_type;
   ...
   */
  public PaymentMethod(br.gabrielsmartins.schemas.order_requested.PaymentType payment_type, java.math.BigDecimal amount) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: payment_type = (br.gabrielsmartins.schemas.order_requested.PaymentType)value$; break;
   ...
   */
  public br.gabrielsmartins.schemas.order_requested.PaymentType getPaymentType() {
    return payment_type;
  }
   ...
   */
  public void setPaymentType(br.gabrielsmartins.schemas.order_requested.PaymentType value) {
   ...
   */
  public static br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder newBuilder() {
    return new br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder();
  }
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder newBuilder(br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder other) {
    if (other == null) {
      return new br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder();
    } else {
      return new br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder(other);
    }
  }
   ...
   * @return A new PaymentMethod RecordBuilder
   */
  public static br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder newBuilder(br.gabrielsmartins.schemas.order_requested.PaymentMethod other) {
    if (other == null) {
      return new br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder();
    } else {
      return new br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentMethod>
    ...
    private br.gabrielsmartins.schemas.order_requested.PaymentType payment_type;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(br.gabrielsmartins.schemas.order_requested.PaymentMethod other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.payment_type)) {
        this.payment_type = data().deepCopy(fields()[0].schema(), other.payment_type);
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder setPaymentType(br.gabrielsmartins.schemas.order_requested.PaymentType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder clearPaymentType() {
      payment_type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder setAmount(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public br.gabrielsmartins.schemas.order_requested.PaymentMethod.Builder clearAmount() {
      amount = null;
    ...
    public PaymentMethod build() {
      try {
        ...
        record.payment_type = fieldSetFlags()[0] ? this.payment_type : (br.gabrielsmartins.schemas.order_requested.PaymentType) defaultValue(fields()[0]);
